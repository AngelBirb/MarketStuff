All of these are going to have the default price vaules as set by whatever examples were provided. Feel free to edit them to your liking when you drop them into the server!
